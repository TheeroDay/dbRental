...
Module ModKoneksiDB
    ...
    Public MyDB = "Driver={MySQL ODBC 8.0 ANSI Driver};Database=dbrental;server:localhost;uid=root"
    Public koneksi As New OdbcConnection(MyDB)

    Public Function Koneksiopen() As OdbcConnection
        Try
    ...
    Public Function koneksiclose() As OdbcConnection
        koneksi.Close()
        Return koneksi
    End Function
End Module
