...
Public Class ClsCtlDetail : Implements InfProses
    ...
    Public Function cariData(kunci As String) As DataView Implements InfProses.cariData
        Try
            DTA = New OdbcDataAdapter("SELECT tbl_user.nama_user, tbl_driver.nama_driver, tbl_mobil.merk, tbl_transaksi.tgl_sewa, tbl_transaksi.tgl_kembali, tbl_transaksi.hari, tbl_transaksi.harga, tbl_transaksi.total_harga
