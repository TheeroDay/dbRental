...
Public Class Booking
    ...
    Private Sub cmbDriver_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbDriver.SelectedIndexChanged
        ...
        If DTR.HasRows Then
            ...
            txtNotel.Text = DTR.Item("no_telp")
        End If
    End Sub
    ...
    Private Sub Book_Click(sender As Object, e As EventArgs) Handles Book.Click
        With EntitasBooking
            ...
            .IdUser = KodeLog
            If txtDriver.Text = "" Or txtDriver.Text = "0" Then
                .IdDriver = "0"
            Else
                .IdDriver = txtDriver.Text
            End If

            If txtNotel.Text = "" Then
                .NoTelp = txtNotel.Text
            Else
                .NoTelp = txtNotel.Text
            End If
        ...
        With Detail_Booking
            ...
            If DTPMulai.Value < DTPSelesai.Value Or DTPMulai.Value = DTPSelesai.Value Then
            ...
            .xTotal1.Text = .xHarga.Text * .xHari.Text
            .xBayar1.Visible = False
